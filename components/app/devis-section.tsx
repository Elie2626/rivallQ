    ...
    return (
      <div className="space-y-3">
        <div className="rounded-2xl border border-violet-500/30 bg-violet-600/10 p-5 flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500">Site vitrine dès 500€ · Devis en temps réel · Livraison en 24h à 3 semaines</p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between px-1">
          <p className="text-xs text-zinc-600">Une question ? Contactez-nous directement.</p>
          <WhatsAppBadge />
        </div>
      </div>
    )
