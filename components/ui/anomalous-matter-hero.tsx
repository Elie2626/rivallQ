...
// ── Sphère wireframe animée — fond transparent ──────────────
  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({
      uniforms: {
        ...
        // Rouge Optify #C1121F
        color:         { value: new THREE.Color('#C1121F') },
      },
      vertexShader: `
        uniform float time;
        ...
        void main(){
          vNormal   = normal;
          vPosition = position;
          float d   = snoise(position*2. + time*0.5)*0.2;
      ...
      fragmentShader: `
        ...
        void main(){
          ...
          vec3  final  = color*diff + color*fresnel*0.5;
          // légère transparence sur le fond clair
          gl_FragColor = vec4(final, 0.55);
        }
      `,
      wireframe:   true,
      transparent: true,
