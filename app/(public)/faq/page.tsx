...
const faqItems = [
  ...
  { question: "Que contient exactement l'audit à 4,99€ ?", answer: "Score SEO (0-100), score UX, score de conversion, top 10 des problèmes critiques, analyse des mots-clés, recommandations prioritaires, et un lien vers le questionnaire de devis pour créer votre nouveau site." },
